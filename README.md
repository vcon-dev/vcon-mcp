...
| Tool | Description |
|------|-------------|
| `vcon_aggregate` | Server-side rollup for rate-style questions (share of vCons matching a tag filter, per group); returns `filtered_count` and `baseline_count` per group |
